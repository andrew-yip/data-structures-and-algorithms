...
public class Problem2 {
	...
	public static void main(String[] args) {
		...
		// INSTANTIATE ELEVEN FRACTION OBJECTS. // creating objects
		
        Fraction f1 = new Fraction(); // creating fraction object // calling constructor to make object? 
        ...
        f1.setNumerator(3); // setting numerator as 3 // updating
        f1.setDenominator(5); // setting denominator as 5
